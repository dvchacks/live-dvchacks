        ...
        <v-card elevation=8 color="#ccc">
            ...
            <v-card-text class="text-md-center">
                ...
                <v-card-actions class="justify-center">  
                    <v-btn large href="/" target="_blank" :outline="!hover" color="#006651"  @mouseenter="hover = true" @mouseleave="hover = false">
                        <span class="mr-2 button-text" :class="{hover}">Submit on Devpost</span>
                    </v-btn>
                </v-card-actions>
        </v-card>
    </v-container>
